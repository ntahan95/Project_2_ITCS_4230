...
if instance_exists(obj_claw)
{
	...
	*/
	...
	"\nThe phrase: 'A dragon only uses its claw to pick greens out of its teeth' is x'd out...");
}
/*
else {
	//add puzzle involving recipe here
